 ...
 * application.
 */
class Zcon1HomeFragment : BaseFragment() {//, SwipeRefreshLayout.OnRefreshListener, HomePresenter.HomeView {
...
//            this@Zcon1HomeFragment.sharedElementEnterTransition = this
//            this@Zcon1HomeFragment.sharedElementReturnTransition = this
//        }
//    }
//
...
//
//        with(binding.includeContent.refreshLayout) {
//            setOnRefreshListener(this@Zcon1HomeFragment)
